...
static const std::unordered_set<std::wstring_view>& GetInvalidMonsterNames() {
	static auto* invalid_monster_names =
			new std::unordered_set<std::wstring_view> {
					d2lang::universal::GetLocaleText(D2STR_MAGGOT2),
					d2lang::universal::GetLocaleText(D2STR_DUMMY),
					d2lang::universal::GetLocaleText(D2STR_DUMMY_2),
					d2lang::universal::GetLocaleText(D2STR_NOT_USED),
					d2lang::universal::GetLocaleText(D2STR_UNUSED),
					d2lang::universal::GetLocaleText(D2STR_NOT_USED_2),
			};
